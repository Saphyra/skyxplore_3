function MapShower(mapElements, gameData){
...
function StarElement(star){
    try{
        this.star = star;
        this.starMapElement = this.createStarMapElement();
        this.starNameMapElement = this.createStarNameMapElement();
    ...
    this.createStarMapElement = function createStarMapElement(){
        try{
    ...
    this.createStarNameMapElement = function createStarNameMapElement(){
        try{
